  ...
  return (
    ...
    >
      <div className="section-wrapper">
        <div className="container mx-auto max-w-[480px] py-14 md:mb-3 md:grid md:max-w-[960px] md:grid-cols-3 md:gap-5 md:py-16 xl:mb-6 xl:max-w-7xl xl:grid-cols-4 xl:gap-6 xl:py-[104px]">
